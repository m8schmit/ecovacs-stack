...
import { getMapSubsetsList, getVacuumMap, getVacuumPos } from '../../store/vacuum/vacuumSlice';
...
const VacuumMap = () => {
  ...
  const [roomsLayer] = useState<VectorLayer<VectorSource<Polygon>>>(
    new VectorLayer({
      style: new Style({
        stroke: new Stroke({
          color: 'blue',
  ...
  useEffect(() => {
    ...
    if (!initialized) {
      ...
      const initialMap = new Map({
        ...
        layers: [mainLayer, roomsLayer, dockLayer, botLayer],
        view: new View({
